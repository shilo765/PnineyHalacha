...
public final class AddBookmarkRussianBinding implements ViewBinding {
  @NonNull
  ...
  private AddBookmarkRussianBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static AddBookmarkRussianBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AddBookmarkRussianBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.add_bookmark_russian, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AddBookmarkRussianBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AddBookmarkRussianBinding((RelativeLayout) rootView, dialogButtonOK,
