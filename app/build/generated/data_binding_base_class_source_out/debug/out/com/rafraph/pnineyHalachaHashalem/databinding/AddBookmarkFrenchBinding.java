...
public final class AddBookmarkFrenchBinding implements ViewBinding {
  @NonNull
  ...
  private AddBookmarkFrenchBinding(@NonNull RelativeLayout rootView, @NonNull Button dialogButtonOK,
      @NonNull EditText editTextBookmarkName, @NonNull TextView include,
      @NonNull RelativeLayout layoutRoot, @NonNull Spinner spinner1) {
  ...
  @NonNull
  public static AddBookmarkFrenchBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AddBookmarkFrenchBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.add_bookmark_french, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AddBookmarkFrenchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AddBookmarkFrenchBinding((RelativeLayout) rootView, dialogButtonOK,
